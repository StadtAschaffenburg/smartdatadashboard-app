...
export default function BevoelkerungContent({ data }: ContentProps) {
  ...
  useEffect(() => {
    ...
    setValue({
      current: current.stadt * 1,
      previous: previous ? previous.stadt * 1 : null,
    })
  }, [yearIndex])
  ...
  return (
    <div>
      <div className="mb-4 flex flex-row gap-6">
        <span>
          <IconPlaceholder className="h-20 fill-society md:h-32" />
        </span>
        <div className="flex flex-grow flex-col justify-center">
          <Title as="h4" variant={'society'}>
            <span>Einwohner:</span>{' '}
