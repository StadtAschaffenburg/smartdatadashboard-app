export const SdgImageMap: Record<string, string> = {
  ...
  'gesundheit-und-wohlergehen': require('@/assets/icons/SDG/SDG-icon-DE-03.jpg')
    .default.src,
  ...
  'weniger-ungleichheiten': require('@/assets/icons/SDG/SDG-icon-DE-10.jpg')
    .default.src,
  ...
  'massnahmen-zum-klimaschutz': require('@/assets/icons/SDG/SDG-icon-DE-13.jpg')
    .default.src,
  'leben-unter-wasser': require('@/assets/icons/SDG/SDG-icon-DE-14.jpg').default
    .src,
